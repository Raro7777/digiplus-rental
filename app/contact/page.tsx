...
export const metadata: Metadata = {
  title: "문의하기",
  description: `${site.name} 전화·팩스·이메일·찾아오시는 길 안내입니다.`,
};
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-2 text-sm text-slate-500">
        {site.companyEn} · {site.businessLine}
      </p>
      ...
      <div className="mt-10 grid gap-6 sm:grid-cols-2">
        <section className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
          <h2 className="text-lg font-semibold text-slate-900">대표 전화 (TEL)</h2>
          <a
        ...
        <section className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
          <h2 className="text-lg font-semibold text-slate-900">휴대폰</h2>
          <a
        ...
        <section className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
          <h2 className="text-lg font-semibold text-slate-900">팩스 (FAX)</h2>
        ...
        <section className="rounded-2xl border border-slate-200 bg-slate-50 p-6">
          <h2 className="text-lg font-semibold text-slate-900">이메일</h2>
          <a
            href={`mailto:${site.email}`}
            className="mt-3 block break-all text-lg font-medium text-brand-blue hover:underline"
          >
            {site.email}
          </a>
        </section>
        ...
        <section
          id="kakao"
          className="rounded-2xl border border-slate-200 bg-slate-50 p-6 sm:col-span-2"
        >
      ...
      <section className="mt-10 rounded-2xl border border-slate-200 p-6">
        <h2 className="text-lg font-semibold text-slate-900">찾아오시는 길</h2>
