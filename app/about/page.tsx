...
export const metadata: Metadata = {
  title: "회사 소개",
  description: `${site.name} — 부천·인천·시흥·안산 사업장 복합기 렌탈, D470·bizhub 상담, 토너·AS.`,
};
...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      <p className="mt-2 text-sm font-medium text-brand-blue">{site.positioningLine}</p>
      <div className="mt-6 max-w-3xl space-y-4 text-base leading-relaxed text-slate-600">
        <p>
          디지플러스({site.companyEn})는 {coreServiceCities.join("·")} 지역
          사업장을 대상으로 복합기 렌탈, 프린터 임대, 토너 관리, AS 상담을
          제공하는 사무기기 렌탈 전문 업체입니다. 신도리코 D470, 태흥아이에스
          bizhub 등 주력 라인을 중심으로 상담드립니다.
        </p>
        <p className="mt-4">
          고객의 월 출력량과 사용 환경을 기준으로 과한 장비가 아닌 적정 장비와
          렌탈 조건을 안내드립니다. 기존 복합기 렌탈료 비교와 무료 진단도
          가능합니다.
        </p>
      </div>
